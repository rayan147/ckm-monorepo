...
<script lang="ts">
  ...
  import { default as RecipeOverview } from '$lib/components/recipes/tabs/overview-tab.svelte';
  import { default as RecipeIngredients } from '$lib/components/recipes/tabs/ingredients-tab.svelte';
  import { default as RecipeInstructions } from '$lib/components/recipes/tabs/instructions-tab.svelte';
  import { default as RecipeEquipment } from '$lib/components/recipes/tabs/equipment-tab.svelte';
  import { default as RecipeSafety } from '$lib/components/recipes/tabs/safety-tab.svelte';
