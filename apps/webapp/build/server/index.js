...
import { a as asClassComponent } from './chunks/legacy-server-C7Q-RK4p.js';
import { p as push, c as setContext, a as pop } from './chunks/index6-Dupr8m-u.js';
import {
  H as HttpError,
  j as json,
  t as text,
  ...
  S as SvelteKitError,
  A as ActionFailure
} from './chunks/index-Ddp2AB5f.js';
import {
  a as decode_pathname,
  b as decode_params,
  n as normalize_path,
  c as disable_search,
  r as resolve,
  ...
  f as readable,
  w as writable
} from './chunks/exports-CidET19a.js';
import './chunks/events-g2LF9d7j.js';
...
async function get_hooks() {
  ...
  let handleError;
  let init;
  ({ handle, handleFetch, handleError, init } = await import('./chunks/hooks.server-Cdn_t-Pt.js'));
  let reroute;
  let transport;
  return {
    handle,
