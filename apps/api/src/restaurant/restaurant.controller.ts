...
export class RestaurantController {
  ...
  async createRestaurant() {
    return tsRestHandler(
      contract.restaurant.createRestaurant,
      async ({ body }) => {
  ...
  async getRestaurants() {
    return tsRestHandler(
      contract.restaurant.getRestaurants,
      async ({ query }) => {
  ...
  async getRestaurant() {
    return tsRestHandler(
      contract.restaurant.getRestaurant,
      async ({ params }) => {
  ...
  async updateRestaurant() {
    return tsRestHandler(
      contract.restaurant.updateRestaurant,
      async ({ params, body }) => {
  ...
  async deleteRestaurant() {
    return tsRestHandler(
      contract.restaurant.deleteRestaurant,
      async ({ params }) => {
