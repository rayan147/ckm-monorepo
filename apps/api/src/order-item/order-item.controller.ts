...
export class OrderItemController {
  ...
  async createOrderItem() {
    return tsRestHandler(contract.orderItem.createOrderItem, async ({ body }) => {
  ...
  async getOrderItems() {
    return tsRestHandler(contract.orderItem.getOrderItems, async ({ query }) => {
  ...
  async getOrderItem() {
    return tsRestHandler(contract.orderItem.getOrderItem, async ({ params }) => {
  ...
  async updateOrderItem() {
    return tsRestHandler(contract.orderItem.updateOrderItem, async ({ params, body }) => {
  ...
  async deleteOrderItem() {
    return tsRestHandler(contract.orderItem.deleteOrderItem, async ({ params }) => {
